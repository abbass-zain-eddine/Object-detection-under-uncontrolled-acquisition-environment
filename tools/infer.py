...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='/home/zeineddine/ICIPCompet/zeineddine-142224/runs/train/exp19/weights/best_ckpt.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='/home/zeineddine/ICIPCompet/zeineddine-142224/datanew/dataset/images/test', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--yaml', type=str, default='/home/zeineddine/ICIPCompet/zeineddine-142224/datanew/dataset.yaml', help='data yaml file.')
    ...
    parser.add_argument('--iou-thres', type=float, default=0.55, help='NMS IoU threshold for inference.')
