...
import torch
from yolov6.layers.common import BottleRep, RepVGGBlock, RepBlock, BepC3, SimSPPF, SPPF, SimCSPSPPF, CSPSPPF, ConvWrapper,ConvDepthWise
...
class CSPBepBackbone_P6(nn.Module):
    ...
    def __init__(
        ...
        self.stemDepthwise = ConvDepthWise(
            in_channels=in_channels,
            out_channels=channels_list[0]//2,
            final_output_channels=channels_list[0],
            kernel_size=3,
            stride=2
        )
