...
from yolov6.DCNv2.DCN.dcnv2 import DeformableConv2d as  DCNv2 
...
class ConvDepthWise(nn.Module):
    '''Depth wise Conv with SiLU activation'''
    def __init__(self, in_channels, out_channels,final_output_channels,kernel_size, stride, groups=1, bias=False):
        super().__init__()
        ...
        self.bn = nn.BatchNorm2d(final_output_channels)
        self.act = nn.SiLU()

    def forward(self, x):
        o=self.act(self.depthwise1(x))
        o=self.act(self.depthwise2(o))
        o=self.act(self.depthwise3(o))
        return self.act(self.bn(self.Defconv(o)))

    def forward_fuse(self, x):
        o=self.act(self.depthwise1(x))
        o=self.act(self.depthwise2(o))
        o=self.act(self.depthwise3(o))
        return self.act(self.Defconv(o))
